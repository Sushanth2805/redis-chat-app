...
export default async function Home() {
  ...
  try {
    ...
    layoutValue = await (await cookieStore).get("react-resizable-panels:layout")
      ?.value;
  } catch (error) {
    console.error("Error accessing cookies:", error);
    // Handle the error, possibly by providing a default value or logging.
  }

  const defaultLayout = layoutValue ? JSON.parse(layoutValue) : undefined;
